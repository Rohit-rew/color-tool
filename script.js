    ...
    if(!validhex(hex)) return ;
       ...
       let trimedhex = hex.replace('#' , '')
        ...
        if(trimedhex.length === 3){
            ...
            trimedhex = trimedhex[0]+trimedhex[0]+trimedhex[1]+trimedhex[1]+trimedhex[2]+trimedhex[2]
...
slider.addEventListener('input' , function(){
  ...
  let lightdark = toggleBtn.classList.contains('toggled') ? -slider.value : slider.value
